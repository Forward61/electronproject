    ...
    export default {
        ...
        mounted() {
          var _this = this;
              ...
              console.log(enurl)
              request({
                url:  'http://172.31.210.195:9527/py/textReader?content=' + enurl+'&code=10&program=nw',
                method: "post"
                // ,
                // headers: {
                ...
                if (!error && response.statusCode == 200) {
                  ...
                  _this.ruleForm.jshmc=rtrim(res.subCHString(300,364))
                  _this.ruleForm.yddz=rtrim(res.subCHString(364,490))
                  _this.ruleForm.qfje=rtrim(res.subCHString(679,695))
                  _this.ruleForm.bj=rtrim(res.subCHString(695,711))
                  _this.ruleForm.wyj=rtrim(res.subCHString(711,727))
          ...
          upload(formName) {
            ...
            this.$refs[formName].validate((valid) => {
              if (valid) {
                ...
                var content= _this.ruleForm.filecontent.subCHString(0,300)
                    ...
                    + _this.ruleForm.filecontent.subCHString(727,855)
                ...
                request({
                  url: 'http://172.31.210.195:9527/py/textUpload?content='+enurl+'&code=02&program=nw',
                  method: "post",
                  headers: {
                    "content-type": "application/json",
                  }
