...
<template>
    <div>
        <el-button type="primary" disabled><router-link id ="limitReq" to="/">挡板——梧州缴存确认响应</router-link></el-button>
        ...
        <el-form-item label="交易名称" prop="name">
            <el-form-item v-model="ruleForm.name" >挡板——梧州缴存确认响应</el-form-item>

        </el-form-item>

        <el-form-item label="返回码(2位，00成功，其他失败)" prop="fhm">
          ...
          var _this = this;
              ...
              request({
                ...
                if (!error && response.statusCode == 200) {
                  ...
                  _this.ruleForm.fhm=response.body
                } else {
